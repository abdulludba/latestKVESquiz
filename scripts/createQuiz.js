const p = console.log;
import { isUserSignedIn,storeQuizDataOnDb }from './db.js'
...
if(questionList.childElementCount >= 5){
    const quizSubj = selectedSubjet.value
storeQuizDataOnDb(quizQuestions,uid,loading,quizSubj)
}else{
alert("The minimum requirements for questions has not been met")
}
